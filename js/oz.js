    ...
    function getOZInfo(place) {
        ...
        query_OZ.run(function (error, featureCollection, response){
            if (featureCollection.features.length == 0){
                document.getElementById("OZAnswer").innerHTML = "<p>This property is not located in an Opportunity Zone.</p><p> <a href='https://www.philaopportunityzones.org/pages/ozmap' style='text-decoration: underline'>Find out more</a>.</p>"
            }
            else {
                document.getElementById("OZAnswer").innerHTML = "<p>This property is located in an Opportunity Zone!</p> <p><a href='https://www.philaopportunityzones.org/pages/resources' style='text-decoration: underline'>Find out more</a>!</p>";
            }
        })
